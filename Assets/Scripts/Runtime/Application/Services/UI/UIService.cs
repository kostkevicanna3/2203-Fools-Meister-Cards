...
namespace Application.UI
{
    public sealed class UiService : IUiService
    {
        ...
        private GameObject _avatarSelectionButtonPrototype;
        ...
        public async UniTask Initialize()
        {
            ...
            _avatarSelectionButtonPrototype = _uiServiceViewContainer.AvatarSelectionButtonPrefab;
        }
        ...
        public AvatarSelectButton GetAvatarSelectionButton()
        {
            return _factory.Create<AvatarSelectButton>(_avatarSelectionButtonPrototype);
        }
